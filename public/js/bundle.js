  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            url = "".concat(type) === 'password' ? 'http://localhost:3000/api/v1/users/updatePassword' : 'http://localhost:3000/api/v1/users/updateMe';
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
...
var renderMap = function renderMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibW9yaXp1cSIsImEiOiJjbDh4NnB5M2IwM3h4M3VudjN1cGhybW5vIn0.QGGF_tb6vc2OL85_kungqw';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)("/api/v1/bookings/pay/".concat(tourId));
          case 4:
            _context.next = 9;
            break;
          case 6:
